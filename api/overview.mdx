...
- [Generate Workflow](/api/generate-workflow) - AI-powered workflow generation
- [Manage Workflows](/api/manage-workflows) - Save and load workflows
- [Manage Agent Configs](/api/manage-agent-configs) - Agent configuration storage
- [Manage Connections](/api/manage-connections) - Workflow connection management
